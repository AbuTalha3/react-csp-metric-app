...
describe('Detail Component', () => {
  ...
  beforeEach(() => {
    store = mockStore({
      stocks: {
        ...
        stocks: [
          {
            id: '1', companyName: 'Apple Inc', price: 100.00, volume: 1000, beta: 1.5, lastAnnualDividend: 0.5, marketCap: 1000000,
          },
          {
  ...
  it('renders stock details when selectedStockId is set', () => {
    ...
    expect(screen.getByText('city stock views')).toBeInTheDocument();
