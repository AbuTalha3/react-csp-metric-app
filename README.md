...
- The app showcases detailed company profiles along with their performance metrics, allowing users to search their companies and see their `Market Capitalisation` and `PROFIT DIVIDENDS` which are real-time and updated every `1 minute`, `15 minutes`, `30 minutes`, `1 hour`, and `daily historical stock prices`. The App has had several pages.
